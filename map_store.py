...
def update_product(value, df):
    if value == 'Unihep':
        ...
        # print(df['generic'])
        fig3 = px.scatter_map(df, lat="latitude", lon="longitude", size="sales_value", color='sales_value', hover_name='city', zoom=5, height=700, color_continuous_scale='GnBu')
        ...
        fig2 = px.scatter_map(df, lat="latitude", lon="longitude", size='sales_value', color='sales_value',
                              hover_name='city', zoom=4.5, height=700, color_continuous_scale='GnBu')
...
def johor_and_products(value, df):
    if value == 'Unihep':
        ...
        fig3 = px.scatter_map(df, lat="latitude", lon="longitude", size="sales_value", color='sales_value',
                              hover_name='city', zoom=5, height=700, color_continuous_scale='GnBu')
